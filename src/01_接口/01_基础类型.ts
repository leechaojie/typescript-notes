...
// Number
const a1: number = 10 // 十进制
const a2: number = 0b1010 // 二进制
const a3: number = 0o12 // 八进制
const a4: number = 0x12 // 十六进制
...
// 元组类型
const arr3: [string, number, boolean] = ['1', 123, true]
...
// 类型推断
const txt = 100 // 没有明确指定 txt 是什么类型，编译器自动推断为 number 类型
